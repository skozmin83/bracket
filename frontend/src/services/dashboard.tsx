...
import DashboardNotFoundTitle from '@pages/spectator/turnaments/[id]/dashboard/dashboard_404';
import GenericErrorPage from '@pages/spectator/turnaments/[id]/dashboard/generic_dashboard_error';
