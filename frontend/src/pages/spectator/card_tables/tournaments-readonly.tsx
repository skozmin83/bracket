...
import classes from '@components/card_tables/tournaments.module.css';
...
export default function TournamentsReadonlyCardTable({
    ...
    .map((tournament) => (
      <Group key={tournament.id} className={classes.card}>
        <UnstyledButton
          ...
          href={`/spectator/tournaments/${tournament.id}/dashboard`}
          w="100%"
        >
